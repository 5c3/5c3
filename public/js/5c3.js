...
(function() {
  ...
  FiveC3 = (function() {
    ...
    function FiveC3() {
      ...
      this.displayEventsInGrid = __bind(this.displayEventsInGrid, this);

      this.filterEvents = __bind(this.filterEvents, this);

      this.showEventsBySize = __bind(this.showEventsBySize, this);

      this.typeaheadSource = __bind(this.typeaheadSource, this);

      this.onPopularSizeClick = __bind(this.onPopularSizeClick, this);
      ...
      this.templates = {};
      templateFiles = ['item', 'items', 'popunder', 'typeahead', 'itemsIsotope'];
    ...
    FiveC3.prototype.initBbq = function() {
      ...
      $(window).bind("hashchange", function(e) {
        ...
        if (url.sizeBy === 'popularity') {
          _this.showEventsBySize('popularity');
          return;
        }
    ...
    FiveC3.prototype.onPopularSizeClick = function(e) {
    ...
    FiveC3.prototype.showEventsBySize = function(sizeCriteria) {
      var event, limitedEvents, sortedData, _i, _len;
      sortedData = this.events.slice(0);
      ...
      for (_i = 0, _len = limitedEvents.length; _i < _len; _i++) {
        event = limitedEvents[_i];
        console.log(event.popularity);
      }
      return this.displayEventsInGrid(limitedEvents);
    };
    ...
    FiveC3.prototype.filterEvents = function(filterattributes) {
      ...
      return this.displayEventsInGrid(filteredData);
    };

    FiveC3.prototype.displayEventsInGrid = function(events) {
      var i, item, j, _i, _len;
      i = 0;
      j = 0;
